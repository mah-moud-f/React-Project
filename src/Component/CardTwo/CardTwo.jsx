  ...
  <div className="card2 row">
        ...
        <div className="row col-sm-12 col-md-12 col-lg-8 col-xl-8">
          ...
          <div className="col-sm-12 col-md-12 col-lg-5 col-xl-5">
            ...
            <div
              className="intro p-3 rounded shadow-sm mb-3"
            ...
            <div
              ...
              style={{backgroundColor: "white"}}
            >
              <span><h4 style={{color: "#050505"}}>Photos</h4></span>
            ...
            <div
              ...
              style={{backgroundColor: "white"}}
            >
              <span><h4 style={{color: "#050505"}}>Friends</h4></span>
          ...
          <div className="col-sm-12 col-md-12 col-lg-7 col-xl-7">
            ...
            <div
              className="mind p-3 rounded shadow-sm mb-3"
              style={{backgroundColor: "white"}}
            >
              <div className="row">
                <div className="col-1">
              ...
              <div className="live row">
                <div
                  ...
                  style={{color: "#717383", fontWeight: "500"}}
                >
                  <i className="fa-solid fa-video" style={{color: "#ff3050"}}></i> Live
                  video
                </div>
                <div
                  className="col-4 text-center"
                ...
                <div
                  ...
                  style={{color: "#717383", fontWeight: "500"}}
                >
                  <i className="fa-solid fa-flag" style={{color: "#0000ff"}}></i> Life
                  event
                </div>
              </div>
            </div>
            ...
            <div
              className="posts p-3 rounded shadow-sm mb-3"
              style={{backgroundColor: "white"}}
            >
              <div className="row">
                <div className="col-6"><h4 style={{color: "#050505"}}>Posts</h4></div>
            ...
            <div
              className="pind row p-3 rounded shadow-sm mb-3 mx-0"
              style={{backgroundColor: "white"}}
            >
