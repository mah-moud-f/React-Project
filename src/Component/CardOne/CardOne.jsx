  ...
  <div className="card1 mb-3 container">
        ...
        <div className="smallpic row justify-content-center">
            ...
            <div className="col-12 col-lg-4" id="name-friends">
              <h2 style={{color: "#050505"}} id="name">هاجر مراد</h2>
            ...
            <div className="col-12 col-lg-5 align-self-center" id="add-edit">
              <span>
                <button type="button" className="btn btn-primary" id="add">
                  <i className="fa-solid fa-plus" style={{color: "#ffffff"}}> </i>Add to
                  story
                </button></span
              >
              <span id="edit">
        ...
        <div className="line row">
          ...
          <div className="col-sm-12 col-md-12 col-lg-8 col-xl-8"><hr /></div>
          <div className="col-2"></div>
        </div>
        ...
        <div className="post row">
          <div className="col-2"></div>
          <div
            className="row col-sm-12 col-md-12 col-lg-8 col-xl-8 col-12"
                ...
                >
                  <div className="btn-group" role="group">
                    ...
                    <ul className="dropdown-menu">
                      <li><a className="dropdown-item" href="#">Check-ins</a></li>
                      ...
                      <li>
                        <a className="dropdown-item" href="#">App and games</a>
                      </li>
                      <li><a className="dropdown-item" href="#">Likes</a></li>
                      <li><a className="dropdown-item" href="#">Events</a></li>
                      <li>
                        <a className="dropdown-item" href="#">Reviews given</a>
                      </li>
                      <li><a className="dropdown-item" href="#">Groups</a></li>
                      <li>
                        <a className="dropdown-item" href="#">Manage sections</a>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-regular fa-eye"></i> View As</a
                      >
                    </li>
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-solid fa-magnifying-glass"></i> Search</a
                      >
                    </li>
                    <li>
                      <a className="dropdown-item" href="#">
                    ...
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-solid fa-box-archive"></i> Archive</a
                      >
                    </li>
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-regular fa-clock"></i> Story archive</a
                      >
                    </li>
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-solid fa-list"></i> Activity log</a
                      >
                    </li>
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-regular fa-circle-user"></i> Profile and
                        tagging
                      </a>
                    </li>
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-solid fa-lock"></i> Look profile</a
                      >
                    </li>
                    <li>
                      <a className="dropdown-item" href="#"
                        ><i className="fa-solid fa-briefcase"></i> Turn on
                        professional mode</a
                      >
                    </li>
                  </ul>
